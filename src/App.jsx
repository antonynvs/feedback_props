...
export function App() {
    ...
    return(
        submited === false ? (
            <div className="bg-radil-gradient text-white rounded-2xl p-6 max-w-103 font-overpass">
            ...
            <div className="flex justify-between mb-6">
                <button className="bg-dark-blue w-10.5 h-10.5 rounded-full text-sm text-medium-grey focus:bg-medium-grey focus:text-white font-bold hover:bg-orange hover:text-white cursor-pointer duration-700 sm:w-13 sm:h-13" onClick={() => handleChangeRateNote(1)}>1</button>
                <button className="bg-dark-blue w-10.5 h-10.5 rounded-full text-sm text-medium-grey focus:bg-medium-grey focus:text-white font-bold hover:bg-orange hover:text-white cursor-pointer duration-700 sm:w-13 sm:h-13" onClick={() => handleChangeRateNote(2)}>2</button>
                <button className="bg-dark-blue w-10.5 h-10.5 rounded-full text-sm text-medium-grey focus:bg-medium-grey focus:text-white font-bold hover:bg-orange hover:text-white cursor-pointer duration-700 sm:w-13 sm:h-13" onClick={() => handleChangeRateNote(3)}>3</button>
                <button className="bg-dark-blue w-10.5 h-10.5 rounded-full text-sm text-medium-grey focus:bg-medium-grey focus:text-white font-bold hover:bg-orange hover:text-white cursor-pointer duration-700 sm:w-13 sm:h-13" onClick={() => handleChangeRateNote(4)}>4</button>
